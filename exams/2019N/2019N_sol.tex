...
\begin{center}
    \begin{tikzpicture}[-,>=stealth',node distance=1cm,initial text=$ $,]
        \tiny
        \node[state                   , fill=red ](0) {};
        \node[state, above right of= 0, fill=blue](10) {};
        \node[state, below right of= 0, fill=blue](11) {};
        \node[state, below right of=10, fill=red ](2) {};
        \node[state, above right of= 2, fill=blue](30) {};
        \node[state, below right of= 2, fill=blue](31) {};
        \node[state, below right of=30, fill=red ](4) {};
...
The two SCCs are coloured blue and red.

\begin{center}
    \begin{tikzpicture}[->,>=stealth',node distance=1.5cm,initial text=$ $,]
        \tiny
        \node[state             , fill=blue](00) {};
        \node[state, right of=00, fill=blue](10) {};
        \node[state, below of=00, fill=blue](01) {};
        \node[state, right of=01, fill=red ](11) {};
        \node[state, right of=11, fill=red ](21) {};
